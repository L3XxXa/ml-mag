...
| 2.2 | kNN | [тык]() | [тык]() | ✅
| 2.3 | SVM | [тык]() | [тык](https://github.com/L3XxXa/ml-mag/blob/main/SVM/svm.ipynb) | ✅
| 3.1 | Naive Bayes | [тык](https://www.kaggle.com/code/prashant111/eda-logistic-regression-pca?select=adult.csv) | [тык]() | ✅
| 3.2 | K-means, K-means++ | сгенерирован | [тык]() | ✅
| 3.3 | DBSCAN | сгенерирован | [тык]() | ✅
| 4.1 | PCA | Использовался в наивном Байесе | [тык]() | ✅
| 4.2 |  Нейронная сеть прямого распространения, классификация | [тык](https://www.kaggle.com/code/prashant111/eda-logistic-regression-pca?select=adult.csv) | [тык]() | ✅
